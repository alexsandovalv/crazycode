...
@XmlRootElement(name = "ObtenerInstitucionRUC")
public class ObtenerInstitucionRUC {

    @XmlElementRef(name = "ruc", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
